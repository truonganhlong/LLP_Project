...
export const title = [
  `Quản lý những thông tin về chương trình học, cấp học, khối học, lớp học`,
  `Lưu trữ tài liệu của bạn, tài liệu được chia sẻ`,
  `Chia sẻ tài liệu của bạn đến với người khác`,
];
